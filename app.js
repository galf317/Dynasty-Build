...
$("begin").onclick=()=>{resetTeamTheme();window.__LEADERBOARD_SUBMITTED=false;demoMode=false;name=$("name").value.trim()||"Rookie One";step=0;picks=[];respins=2;usedTraits=[];show("draw");renderTrait()};
